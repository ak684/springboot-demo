...
export function createLongTimeoutApiClient(clientConfig = {}) {
  return createApiClient({
    timeout: 960000, // 16 minutes timeout for long-running operations (temporary until job queue implementation)
    ...clientConfig,
  });
}
