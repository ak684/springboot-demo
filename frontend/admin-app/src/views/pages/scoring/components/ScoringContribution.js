...
const ScoringContribution = ({ nextStep, name, title, description, items, values, setFieldValue }) => {
    ...
    <CustomErrorBoundary>
      <StepperAnimation>
        <Box>
          ...
          <SliderWrapper label={`${values.contribution}% contribution`}>
            <FormikSlider
              name={name}
              min={1}
              max={100}
...
export default memo(ScoringContribution);
