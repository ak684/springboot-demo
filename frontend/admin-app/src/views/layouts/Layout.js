...
import VentureSidebar from '../common/VentureSidebar';
  ...
  return (
    <CustomErrorBoundary>
      <Box>
        ...
        {!location.pathname.includes('pitch-deck') && !location.pathname.includes('profile') && !location.pathname.includes('ai-toc') && (
          <StyledActionButton
